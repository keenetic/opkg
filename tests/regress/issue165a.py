...
# ======================================
#
# 1. Create packages 'x', 'a','b', and 'c' such that 'a' recommends 'b' and 'c',
#    and 'c' conflicts 'x'.
# 2. Install 'x'.
# 3. Try to install 'a'.
#
...
# =====================================================
#
# 'a' and 'b' should be installed, and 'c' should remain uninstalled.
#
...
if not opkgcl.is_installed("a"):
    opk.xfail("Package 'a' not installed even though 'c' is not an absolute dependency of 'a'.")
